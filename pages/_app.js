...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Bhavesh Gurav";
	const description =
		"Hello! I'm Bhavesh Gurav, a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
	...
	return (
		<>
			<Head>
				...
				<meta name="twitter:creator" content="@bhaveshgurav369" />
